...
const BASE_URL = process.env.BASE_URL || 'http://challenge:33333/'
const FLAG = process.env.FLAG || 'grey{this_is_the_flag_for_real}'
...
const visitSubmission = async (id) => {
    ...
    try {
        await page.goto(BASE_URL + 'image/' + id, { waitUntil: 'networkidle2', timeout: 5000 })
    }
    catch (e) {
        console.log(e)
    }
